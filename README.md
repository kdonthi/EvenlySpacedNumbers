...
UDPATE: I have created an accurate solution and fast solution in Java using dynamic programming by storing the values of lists continuous from any index to the end of the array.
