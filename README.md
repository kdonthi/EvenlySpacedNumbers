...
<h1> optimalSubsampleTrees.py </h1>
...
<h1> optimalSubsample.java </h1>
I have created an accurate solution and fast solution in Java using dynamic programming by storing the values of lists continuous from any index to the end of the array.
